...
import com.leontran.find2buy.model.ObjectByteArrary;
...
public class Utils {
	...
	public void setStringPref(String prefKeyname, String value) {
		if (mPrefUtil != null) {
			ObjectByteArrary data = new ObjectByteArrary();
	...
	public String getStringPref(String prefName) {
		if (mPrefUtil != null && mPrefUtil.hasKey(prefName)) {
			...
			ObjectByteArrary data = MPreferenceManager.getClassFromJson(json,
					ObjectByteArrary.class);
